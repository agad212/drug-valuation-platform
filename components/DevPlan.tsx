      ...
      <div style={{ flex: 1, border: `1px solid ${color}40`, borderRadius: 10, background: "var(--surface)", marginBottom: 12, overflow: "hidden" }}>
        ...
        <div style={{ background: `${color}12`, borderBottom: `1px solid ${color}25`, padding: "10px 14px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <div style={{ textAlign: "right", flexShrink: 0 }}>
            ...
            {stage.successCeilingBound != null && (
              <div title="Detection ≠ certain success. No single trial is near-certain; a confirmatory (Phase 3) trial in a hard indication carries an irreducible base-rate failure hazard even after a positive earlier stage." style={{ fontSize: 9, color: "#f59e0b", marginTop: 3, maxWidth: 160, lineHeight: 1.3 }}>
                capped at base-rate ceiling {fmtPct(stage.successCeilingBound)} (raw {fmtPct(stage.trialSuccessProbRaw)})
              </div>
            )}
