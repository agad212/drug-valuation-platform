...
export default function DecisionAnalysis({ valuation, out, ptrsResult, layer2Result, effectPrior, devPlan, persisted, onPersistedChange, readOnly = false }: Props) {
                ...
                <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                  {(() => {
                    ...
                    <ResultCard
                      ...
                      onApplyDesign={readOnly ? undefined : applyDesign}
                    />
                  ));
                  })()}
                </div>
