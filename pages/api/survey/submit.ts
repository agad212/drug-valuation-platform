...
import { SURVEY_QUESTION_IDS } from "../../../lib/survey-questions";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Keep only known question ids with non-empty string values, capped in length.
  ...
  try {
    const saved = await insertSurveyResponse(answers);
